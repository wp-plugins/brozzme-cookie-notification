...
function bcn_options_page(  ) {
    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=brozzme-cookie-notification&tab=general_settings" class="nav-tab <?php echo $active_tab == 'general_settings' ? 'nav-tab-active' : ''; ?>"><?php _e( 'General settings', 'brozzme-cookie-notification' );?></a>
           <a href="?page=brozzme-cookie-notification&tab=accept_template_options" class="nav-tab <?php echo $active_tab == 'accept_template_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Accept / Decline', 'brozzme-cookie-notification' );?></a>
            <a href="?page=brozzme-cookie-notification&tab=policy_template_options" class="nav-tab <?php echo $active_tab == 'policy_template_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Policy template', 'brozzme-cookie-notification' );?></a>
            <a href="?page=brozzme-cookie-notification&tab=display_options" class="nav-tab <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Display', 'brozzme-cookie-notification' );?>Display</a>
            <a href="?page=brozzme-cookie-notification&tab=cookies_options" class="nav-tab <?php echo $active_tab == 'cookies_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Cookies Options', 'brozzme-cookie-notification' );?></a>
