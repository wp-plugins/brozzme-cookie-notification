    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
           ...
           <a href="?page=brozzme-cookie-notification&tab=accept_template_options" class="nav-tab <?php echo $active_tab == 'accept_template_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Accept / Decline', 'brozzme-cookie-notification' );?></a>
            ...
            <a href="?page=brozzme-cookie-notification&tab=display_options" class="nav-tab <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Display', 'brozzme-cookie-notification' );?></a>
